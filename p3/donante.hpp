...
namespace ed{
    ...
    class Donante:public DonanteInterfaz{
        ...
        public:
            ...
            */
            Donante(const std::string &nombre="", const std::string &apellidos="", const std::string &gSanguineo="", const std::string &factorRH="", const uint &donaciones=0): _nombre(nombre), _apellidos(apellidos), _gSanguineo(gSanguineo), _factorRH(factorRH), _donaciones(donaciones){}
            /*
            * @brief Constructor de copia.
            * @param d Donante del que crear el nuevo donante.
            */
            Donante(const Donante &d): _nombre(d.getNombre()), _apellidos(d.getApellidos()), _gSanguineo(d.getGrupoSanguineo()), _factorRH(d.getFactorRH()), _donaciones(d.getDonaciones()){}
            /** @name Observadores. */
            /*
            ...
            * @return Número de donaciones del donante.
            */
            uint getDonaciones() const{
                return _donaciones;
            }
            ...
            * @param donaciones Número de donaciones.
            */
            void setDonaciones(const uint &donaciones){
            ...
            */
            void leerDonante(){
                ...
                uint opcion1, opcion2, donaciones;
                do{
                ...
                std::cout << "Introduce el número de donaciones realizadas por el donante: ";
                std::cin >> donaciones;
                this->setNombre(nombre);
                this->setApellidos(apellidos);
                this->setGrupoSanguineo(gSanguineo[opcion1-1]);
                this->setFactorRH(factorRH[opcion2-1]);
                this->setDonaciones(donaciones);
            }
            /*
            ...
            */
            void mostrarDonante() const {
                if(this->getNombre() == "" || this->getApellidos() == ""){
                    ...
                    std::cout << "\t\e[1;4mDonaciones\e[0m      : " << this->getDonaciones() << std::endl;
                }
            }
            ...
            * @brief Sobrecarga del operador <
            * @param d Donante.
            * @return true si this->getDonaciones() < d.getDonaciones(), false si no.
            * @sa getDonaciones()
            */
            bool operator < (const Donante &d) const {
                return this->getDonaciones() < d.getDonaciones();
            }
            /**
            * @brief Sobrecarga del operador >
            * @param d Donante.
            ...
            */
            friend std::ostream &operator <<(std::ostream &output, const Donante &d){
                ...
                output << d.getApellidos() << ", " << d.getNombre() << " ( " << d.getGrupoSanguineo() << d.getFactorRH() << " ) <" << d.getDonaciones() << " donaciones>" << std::endl;
                return output;
            }
            /**
            ...
            */
            void modificarDonante(){
                uint opcion_1, opcion_2, donaciones;
                std::string nombre, apellidos, gSanguineo[] = {"0", "A", "B", "AB"}, factorRH[] = {"+", "-"};
                ...
                switch (opcion_1) {
                    ...
                    case 4:
                        ...
                        break;
                    case 5:
                        std::cout << "Introduce el número de donaciones del donante: ";
                        std::cin >> donaciones;
                        this->setDonaciones(donaciones);
                        break;
                }
